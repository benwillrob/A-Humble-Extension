document.addEventListener("DOMContentLoaded", () => {
  ...
  // Function to format message text, converting markdown-style bold text to HTML
  const formatMessageText = (text) => {
    ...
    // Then convert markdown-style bold text to HTML
...
[Error stringifying data: ${e.message}]`
  ...
  // Update the renderChatHistory function to handle formatting
  ...
  chrome.storage.local.get(["selectedText"], (result) => {
    if (result.selectedText && userInput) {
